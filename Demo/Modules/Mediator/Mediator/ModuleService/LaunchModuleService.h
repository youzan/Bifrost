...
#ifndef LaunchModuleService_h
#define LaunchModuleService_h
...
//static NSString *const kRouteLaunch*** = @"//launch/***";
 ...
 */
@protocol LaunchModuleService <NSObject>


@end

NS_ASSUME_NONNULL_END
#endif /* LaunchModuleService_h */
